$(document).ready(function () {
	...
	$('.home__carousel__odd').owlCarousel({
		mouseDrag: true,
		touchDrag: true,
		dots: false,
		loop: true,
	...
	$('.home__nav--next').on('click', function(e) {
		
		const target = $($(e.target).parent().parent().children()[1]).children()[0];
		$(target).trigger('next.owl.carousel');
	});
	$('.home__nav--prev').on('click', function(e) {
		const target = $($(e.target).parent().parent().children()[1]).children()[0];
	...
	$('.home-slider .owl-next').on('click', function(e) {
		const target = $('.home-slider')[0];
		$(target).trigger('next.owl.carousel');
	})
	/*==============================
	Tabs

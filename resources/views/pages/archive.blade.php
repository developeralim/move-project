                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section__wrap">
                            {{-- section title --}}
                            <h1 class="section__title">All Movie Under {{ $category }}</h1>
                            {{-- end section title --}}
                            {{-- breadcrumb --}}
                            <ul class="breadcrumb">
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card">
                                <a href="{{ route('single', [$_movie['id'], $_movie['drive_id']]) }}" class="card__cover">
                                    <img src="{{ asset($_movie['cover_photo']) }}" alt="{{ $_movie['name'] }}">
                        ...
                        <div class="col-12">
                            <div class="paginator-wrap">
                                <ul class="paginator">
                                    ...
                                    <li
                                        class="paginator__item paginator__item--prev {{ $prev_disable == 'true' ? 'disabled' : '' }}">
                                    ...
                                    @if ($prev != 1)
                                        <li class="paginator__item">
                                            <a
                                                href="{{ request()->fullUrlWithQuery(['page' => $prev]) }}">{{ $prev }}</a>
                                        </li>
                                    @endif

                                    <li class="paginator__item paginator__item--active">
                                        <a
                                            href="{{ request()->fullUrlWithQuery(['page' => $current_page]) }}">{{ $current_page }}</a>
                                    </li>

                                    @if ($last_page != $current_page)
                                        <li class="paginator__item">
                                            <a
                                                href="{{ request()->fullUrlWithQuery(['page' => $next]) }}">{{ $next }}</a>
                                        </li>
                                    @endif

                                    <li
                                        class="paginator__item paginator__item--next {{ $next_disable == true ? 'disabled' : '' }}">
